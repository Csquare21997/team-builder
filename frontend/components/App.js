...
export default function App() {
  ...
  const submitNewMember = () => {
    ...
    const newMember = {fname,lname,bi, id:getId ()}
      ...
      <div id="membersForm">
        ...
        <form onSubmit={onsubmit}>
          <div>
            ...
            <input onChange = {onchange} value={value.fname} id="fname" type="text" placeholder="Type First Name" />
          </div>

          <div>
            <label htmlFor="lname">Last Name </label>
            <input onChange = {onchange}value={value.lname}  id="lname" type="text" placeholder="Type Last Name" />
          </div>

          <div>
            <label htmlFor="bio">Bio </label>
            <textarea onChange = {onchange}value={value.bio onChange = {onchange}}  id="bio" placeholder="Type Bio" />
          </div>
